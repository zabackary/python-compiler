...
def main(argv: list[str]):
    ...
    parser.add_argument("--exports-dictionary-mode",
                        default="dict",
                        choices=["dict", "munch"],
                        help="the method that export dictionaries are converted to dot-accessible objects")
    parser.add_argument("--exports-names-mode",
                        default="locals",
                        choices=["locals", "static"],
                        help="how module exports are determined. use 'locals' for compatibility with existing code")
        ...
        try:
            mm = ModuleMerger(
                ...
                options=ModuleMergerOptions(
                    ...
                    exports_dictionary_mode=args.exports_dictionary_mode,
                    exports_names_mode=args.exports_names_mode,
                ))
            merged = mm.merge()
            if args.minify:
